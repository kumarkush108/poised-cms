...
@section('content')
    <h2 style="margin:0 0 8px; font-size:20px; color:#222222;">New Product Inquiry</h2>
    <p style="margin:0 0 20px; color:#666666;">
        Someone inquired about a product on {{ $siteName }}. Reply directly to this email to respond to them —
