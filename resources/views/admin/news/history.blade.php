...
<div class="page-heading">
    ...
    <div class="page-heading-copy">
        ...
        <div>
            ...
            <h1 class="h3 mb-1">{{ $article->title }} — History</h1>
            <p class="text-muted mb-0">Restoring brings back content values from that point in time.</p>
        </div>
    </div>

    <a href="{{ route('admin.news-articles.edit', $article) }}" class="btn btn-outline-secondary">
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <button type="button"
                                        ...
                                        data-confirm-action="{{ route('admin.news-articles.revisions.restore', [$article, $revision]) }}"
