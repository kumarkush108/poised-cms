...
<div class="page-heading">
    <div class="page-heading-copy">
        ...
        <div>
            ...
            <h1 class="h3 mb-1">Add Blog Post</h1>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.blog-posts.store') }}">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="title" id="post-create-title" class="form-control" value="{{ old('title') }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Slug</label>
                    <div class="input-group">
                        <span class="input-group-text">/blog/</span>
                        <input type="text" name="slug" id="post-create-slug" class="form-control" value="{{ old('slug') }}">
                    </div>
